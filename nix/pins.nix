...
}:
{
  ...
  gyre = (
    import (pkgs.fetchzip {
      url = "https://github.com/VincentVanlaer/nix-gyre/archive/ffb58d4123a46ea297daaf4931d472fcee117095.zip";
      sha256 = "sha256-uvC23rMV8B12pfem6fZ6rXrG7BOaUANAn7UcA5Swg7I=";
    }) { inherit pkgs; }
  );
}
